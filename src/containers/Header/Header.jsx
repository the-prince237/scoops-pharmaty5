...
const Header = () => {
  return (
    <header>
      <img src="" alt="scoops-pharmacy" data-aos="fade-right"/>
      <nav className='large-nav'>
        ...
        <div className='header-buttons'>
          <span className='contact-btn whatsap'><BsWhatsapp /> whatsapp</span>
          <span className='contact-btn telephone'><BiPhone /> 6 55 06 18 36</span>
